...
var component = require("./components/aspnetbuzz");
...
},{"./components/aspnetbuzz":5,"react":162,"typed-react":167}],2:[function(require,module,exports){
/// <reference path="../../typings/react/react.d.ts"/>
/// <reference path="../../node_modules/typed-react/typed-react.d.ts"/>
...
var AspNetBuzzEventStreamClass = (function (_super) {
    __extends(AspNetBuzzEventStreamClass, _super);
    function AspNetBuzzEventStreamClass() {
        _super.call(this);
    }
    AspNetBuzzEventStreamClass.prototype.getInitialState = function () {
        return {
            events: [
            ]
        };
    };
    AspNetBuzzEventStreamClass.prototype.initialize = function () {
        var _this = this;
    ...
    AspNetBuzzEventStreamClass.prototype.componentDidMount = function () {
        this.initialize();
    };
    AspNetBuzzEventStreamClass.prototype.getEventClassName = function (event) {
        var className = "alert";
    ...
    AspNetBuzzEventStreamClass.prototype.isEventSupported = function (eventType) {
        return supportedEvents.indexOf(eventType) >= 0;
    };
    AspNetBuzzEventStreamClass.prototype.render = function () {
        var _this = this;
        var items = this.state.events.map(function (item) {
            if (_this.isEventSupported(item.Type)) {
                return React.DOM.div({ key: item.ID, className: _this.getEventClassName(item) }, React.createElement(GitHub.GitHubEvent, { model: item }, null));
            }
        });
        return React.DOM.div({ id: "stream", className: "news" }, items);
    };
    return AspNetBuzzEventStreamClass;
})(TypedReact.Component);
exports.AspNetBuzzEventStream = TypedReact.createClass(AspNetBuzzEventStreamClass);

},{"./GitHub/GitHubEvents":3,"react":162,"typed-react":167}],3:[function(require,module,exports){
/// <reference path="../../../typings/react/react.d.ts"/>
/// <reference path="../../../node_modules/typed-react/typed-react.d.ts"/>
...
var GitHubEventClass = (function (_super) {
    __extends(GitHubEventClass, _super);
    function GitHubEventClass() {
        _super.apply(this, arguments);
    }
    GitHubEventClass.prototype.render = function () {
        return React.DOM.div({ className: "body" }, [getGitHubEventTemplate(this.props)]);
    };
...
function getBranchUrl(repoName, branchName) {
    return "https://github.com/" + repoName + "/tree/" + branchName;
}
function getBranchCommitUrl(repoName, branchName) {
    return "https://github.com/" + repoName + "/commits/" + branchName;
}
function getForkedRepositoryName(userName, fullRepoName) {
...
},{"marked":7,"react":162,"typed-react":167}],4:[function(require,module,exports){
/// <reference path="../../typings/react/react.d.ts"/>
/// <reference path="../../node_modules/typed-react/typed-react.d.ts"/>
var __extends = this.__extends || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
...
var React = require("react");
var TypedReact = require("typed-react");
var AspNetBuzzHeaderClass = (function (_super) {
    __extends(AspNetBuzzHeaderClass, _super);
    function AspNetBuzzHeaderClass() {
        _super.call(this);
    }
    AspNetBuzzHeaderClass.prototype.getInitialState = function () {
        return {
            title: "ASP.NET 5 Live event feed",
            subTitle: " The only place to get ASP.NET 5 updates!"
        };
    };
    AspNetBuzzHeaderClass.prototype.componentDidMount = function () {
    };
    AspNetBuzzHeaderClass.prototype.render = function () {
        return React.DOM.header({ id: "header", className: "header" }, React.DOM.div({ className: "container" }, React.DOM.a({
...
exports.AspNetBuzzHeader = TypedReact.createClass(AspNetBuzzHeaderClass);

},{"react":162,"typed-react":167}],5:[function(require,module,exports){
/// <reference path="../../typings/react/react.d.ts"/>
/// <reference path="../../node_modules/typed-react/typed-react.d.ts"/>
var __extends = this.__extends || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
...
var React = require("react");
var TypedReact = require("typed-react");
var component = require("./Header");
var streamComponent = require("./EventStream");
var AspNetBuzzClass = (function (_super) {
    __extends(AspNetBuzzClass, _super);
    function AspNetBuzzClass() {
        _super.call(this);
    }
    AspNetBuzzClass.prototype.getInitialState = function () {
        return {};
    };
    AspNetBuzzClass.prototype.componentDidMount = function () {
    };
    AspNetBuzzClass.prototype.render = function () {
        return React.DOM.div(null, React.createElement(component.AspNetBuzzHeader), React.DOM.div({ className: "container" }, React.createElement(streamComponent.AspNetBuzzEventStream)));
    };
    return AspNetBuzzClass;
})(TypedReact.Component);
;
exports.AspNetBuzzApp = TypedReact.createClass(AspNetBuzzClass);

},{"./EventStream":2,"./Header":4,"react":162,"typed-react":167}],6:[function(require,module,exports){
...
},{"././mixin":168}],164:[function(require,module,exports){
...
},{"./extract_prototype":166,"react":162}],165:[function(require,module,exports){
var extractPrototype = require("./extract_prototype");
...
},{"./extract_prototype":166}],166:[function(require,module,exports){
var ILLEGAL_KEYS = {
    constructor: true,
    refs: true,
    props: true,
...
exports.createClass = require("./create_class");
exports.createMixin = require("./create_mixin");
exports.extractPrototype = require("./extract_prototype");
exports.Mixin = require("./mixin");
exports.NotImplementedError = require("././not_implemented_error");

},{"././not_implemented_error":169,"./component":163,"./create_class":164,"./create_mixin":165,"./extract_prototype":166,"./mixin":168}],168:[function(require,module,exports){
...
},{"./not_implemented_error":169}],169:[function(require,module,exports){
